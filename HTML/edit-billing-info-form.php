        ...
        <div class="profile-main-wrapper billing-main-wrapper">
            <div class="profile-nav-wrapper">
                <div class="profile-nav-container">
                    ...
                    <div class="profile-nav-content profile-current-page" onclick="redirect('edit-info')"><span>Billing Info</span></div>
                    ...
                    <div class="profile-content-container billing-content-container">
                        <div id="billing-info-content-container" class="billing-info-content-container">
                            ...
                            <div class="billing-info-wrapper">
                                <form class="billing-info-form" action="../PHP/edit-billing-info-handler.php" method="POST">
                    END;
                    ...
                    echo <<<END
                                        ...
                                        <div class="billing-info-textbox">
                                            ...
                                            <select id="city" name="city">
                                                <option value="$town_city" selected hidden>$town_city</option>
                                            </select>
                                        </div>
                                        </div>             
                                        <div class="billing-info-textbox">
                                        <label for="">Post Code<span>*</span></label>
                                        <input type="number" value="$postcode_zip" id="post_code" placeholder="Enter your Post Code" name="post_code" maxlength='4'>
                                    </div>
                                        <div class="billing-info-textbox">
                                        ...
                                        <input type="hidden" name="hiddenValue" id="hiddenValue" value="edit-billing-info-form">
