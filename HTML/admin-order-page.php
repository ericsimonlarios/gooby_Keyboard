    ...
    <div class="main-admin-page">
        <div class="admin-nav-container">
            <div class="admin-nav-container-wrapper">
                ...
                <div class="admin-nav-content admin-current-page">ORDERS</div>
                        ...
                        <select name="sort_products" id="sort_products" onchange="getOrder()">
                            <?php
                                if(isset($_GET['getOrder'])){
                                    echo '<option value="'. $_GET['getOrder'] . '"selected hidden>'. $_GET['getOrder'] . '</option>';
                                    echo <<<END
                                    <option value="Default Sorting">Default Sorting</option>
                                    <option value="Sort by Latest">Sort by Latest</option>
                                    <option value="Sort by Pending Status">Sort by Pending Status</option>
                                    <option value="Sort by Shipped Status">Sort by Shipped Status</option>
                                    <option value="Sort by Arrived Status">Sort by Arrived Status</option>
                                    END;
                                }else{
                                    echo <<<END
                                    <option value="Default Sorting">Default Sorting</option>
...
<script>
    ...
    function getOrder() {
        ...
        xml.open("GET", "admin-actions.php?getOrder=" + sortValue + "&pages=" + pages, true);
        xml.send();
    }
    ...
    function updateStatus(order_status, order_id) {
        ...
        xml.open("GET", "admin-actions.php?getUpdate=" + order_status + "&order_id=" + order_id + "&sortValue=" + sortValue + "&pages=" + pages, true);
        xml.send();
    }
</script>
